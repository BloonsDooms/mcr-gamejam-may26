...
execute at @s rotated ~ 0 run fill ^-1 ^ ^1 ^1 ^1 ^2 gray_stained_glass replace light_gray_stained_glass
execute at @s rotated ~ 0 run fill ^-1 ^ ^1 ^1 ^1 ^2 black_stained_glass replace gray_stained_glass
execute at @s rotated ~ 0 run fill ^-1 ^ ^1 ^1 ^1 ^2 gray_stained_glass replace light_gray_stained_glass
