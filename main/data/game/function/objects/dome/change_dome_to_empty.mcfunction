...
execute at @n[tag=this,tag=dome,tag=level0] run place template game:domes/dome_0 ~-6 ~ ~-6
...
execute at @n[tag=this,tag=dome,tag=level1] run place template game:domes/dome_1 ~-8 ~ ~-8
...
execute at @n[tag=this,tag=dome,tag=level2] run place template game:domes/dome_2 ~-9 ~ ~-9
...
execute at @n[tag=this,tag=dome,tag=level3] run place template game:domes/dome_3 ~-11 ~ ~-11
execute at @n[tag=this,tag=dome,tag=level3] run fill ~-12 ~ ~-12 ~12 ~ ~12 stone replace air
