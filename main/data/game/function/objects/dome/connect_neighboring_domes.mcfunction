...
# level 2 to level 0.
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level0] feet run fill ^-2 ^ ^8 ^2 ^5 ^20 polished_tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level0] feet run fill ^-2 ^1 ^8 ^2 ^4 ^20 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level0] feet run fill ^-1 ^5 ^8 ^1 ^5 ^20 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level0] feet run fill ^-1 ^ ^8 ^1 ^ ^20 tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level0] feet run fill ^-2 ^ ^7 ^2 ^5 ^7 smooth_basalt
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level0] feet run fill ^-2 ^ ^21 ^2 ^5 ^21 smooth_basalt
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level0] feet run fill ^-1 ^1 ^7 ^1 ^4 ^21 air

# level 2 to level 1.
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level1] feet run fill ^-2 ^ ^8 ^2 ^5 ^19 polished_tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level1] feet run fill ^-2 ^1 ^8 ^2 ^4 ^19 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level1] feet run fill ^-1 ^5 ^8 ^1 ^5 ^19 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level1] feet run fill ^-1 ^ ^8 ^1 ^ ^19 tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level1] feet run fill ^-2 ^ ^7 ^2 ^5 ^7 smooth_basalt
...
# level 2 to level 2.
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level2] feet run fill ^-2 ^ ^8 ^2 ^5 ^17 polished_tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level2] feet run fill ^-2 ^1 ^8 ^2 ^4 ^17 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level2] feet run fill ^-1 ^5 ^8 ^1 ^5 ^17 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level2] feet run fill ^-1 ^ ^8 ^1 ^ ^17 tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level2] feet run fill ^-2 ^ ^7 ^2 ^5 ^7 smooth_basalt
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level2] feet run fill ^-2 ^ ^18 ^2 ^5 ^18 smooth_basalt
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level2] feet run fill ^-1 ^1 ^7 ^1 ^4 ^18 air

# level 2 to level 3.
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level3] feet run fill ^-2 ^ ^8 ^2 ^5 ^15 polished_tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level3] feet run fill ^-2 ^1 ^8 ^2 ^4 ^15 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level3] feet run fill ^-1 ^5 ^8 ^1 ^5 ^15 glass
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level3] feet run fill ^-1 ^ ^8 ^1 ^ ^15 tuff
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level3] feet run fill ^-2 ^ ^7 ^2 ^5 ^7 smooth_basalt
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level3] feet run fill ^-2 ^ ^16 ^2 ^5 ^16 smooth_basalt
execute as @e[tag=target,tag=level2] at @s facing entity @n[tag=this,tag=level3] feet run fill ^-1 ^1 ^7 ^1 ^4 ^16 air
...
#execute as @e[tag=target] at @s facing entity @n[tag=this] feet positioned ^ ^1 ^13 run function game:objects/doors/new_door
