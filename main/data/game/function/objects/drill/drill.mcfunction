...
# refinery
execute at @n[tag=d] if items block ~ ~ ~ container.0 charcoal run scoreboard players add @s t1 1
...
execute at @n[tag=drill] if score @s t1 matches 20.. run item modify block ~ ~ ~ container.0 game:remove_one_item
