...
#
execute if score @s action_timer matches 22 if items entity @s weapon.mainhand *[damage=20] run item replace entity @s weapon.mainhand with carrot_on_a_stick[custom_data={laser:1b},item_name={"italic":false,"text":"Laser"},attribute_modifiers=[{id:"attack_speed",type:"attack_speed",amount:100,operation:"add_value"}],damage=25] 1
execute if score @s action_timer matches 22 if items entity @s weapon.mainhand *[damage=15] run item replace entity @s weapon.mainhand with carrot_on_a_stick[custom_data={laser:1b},item_name={"italic":false,"text":"Laser"},attribute_modifiers=[{id:"attack_speed",type:"attack_speed",amount:100,operation:"add_value"}],damage=20] 1
execute if score @s action_timer matches 22 if items entity @s weapon.mainhand *[damage=10] run item replace entity @s weapon.mainhand with carrot_on_a_stick[custom_data={laser:1b},item_name={"italic":false,"text":"Laser"},attribute_modifiers=[{id:"attack_speed",type:"attack_speed",amount:100,operation:"add_value"}],damage=15] 1
execute if score @s action_timer matches 22 if items entity @s weapon.mainhand *[damage=5] run item replace entity @s weapon.mainhand with carrot_on_a_stick[custom_data={laser:1b},item_name={"italic":false,"text":"Laser"},attribute_modifiers=[{id:"attack_speed",type:"attack_speed",amount:100,operation:"add_value"}],damage=10] 1
execute if score @s action_timer matches 22 if items entity @s weapon.mainhand *[damage=0] run item replace entity @s weapon.mainhand with carrot_on_a_stick[custom_data={laser:1b},item_name={"italic":false,"text":"Laser"},attribute_modifiers=[{id:"attack_speed",type:"attack_speed",amount:100,operation:"add_value"}],damage=5] 1