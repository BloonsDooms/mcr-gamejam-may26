...
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=..0}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=10]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=1}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=20]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=2}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=30]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=3}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=40]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=4}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=50]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=5}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=60]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=6}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=70]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=7}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=80]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=8}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=90]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=9}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=100]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=10}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=110]
execute if items entity @s weapon.mainhand iron_ingot run item replace entity @s[scores={damage_temp=11..}] weapon.mainhand with crossbow[enchantments={"quick_charge":2},enchantment_glint_override=false,max_damage=120,damage=120]
