...
execute if score .run_game .calc matches 1 run function game:game/loop
execute positioned 276.61 65.00 275.18 unless entity @a[distance=..100] if score .run_game .calc matches 1 run function game:end
